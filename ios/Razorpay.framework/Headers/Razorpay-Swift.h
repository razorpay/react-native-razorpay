...
SWIFT_PROTOCOL("_TtP8Razorpay16RazarpayProtocol_")
@protocol RazarpayProtocol
@end
...
+ (Razorpay * _Nonnull)initWithKey:(NSString * _Nonnull)key andDelegate:(id <RazarpayProtocol> _Nonnull)delegate SWIFT_METHOD_FAMILY(none) SWIFT_WARN_UNUSED_RESULT;
...
@protocol RazorpayPaymentCompletionProtocol <RazarpayProtocol>
...
@protocol RazorpayPaymentCompletionProtocolWithData <RazarpayProtocol>
...
@protocol RazorpayResultProtocol <RazarpayProtocol>
