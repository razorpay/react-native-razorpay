...
#ifndef RAZORPAYSTANDARD_SWIFT_H
#define RAZORPAYSTANDARD_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RazorpayStandard",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class WKNavigation;
SWIFT_CLASS("_TtC16RazorpayStandard6Otpelf")
